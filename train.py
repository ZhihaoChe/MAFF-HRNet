...
from nets.FA_HRNet.hrnet import HRnet
...
if __name__ == "__main__":
    ...
    #       在终端中输入    CUDA_VISIBLE_DEVICES=0,1,2,3 python train_FA.py
    #   DDP模式：
    #       设置            distributed = True
    #       在终端中输入    CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node=2 train_FA.py
    #---------------------------------------------------------------------#
    distributed     = False
    #---------------------------------------------------------------------#
    ...
    # model_path      = "/data4/chezhihao/hrnet-pytorch-main/logs/FAHRNet_WHU_Build/best_epoch_weights.pth"
    model_path = ''
    #------------------------------#
    #   输入图片的大小
    #------------------------------#
    ...
    #------------------------------------------------------------------#
    VOCdevkit_path  = '/data4/chezhihao/remote_seg_data/Sentinel2_Paris/'
    #------------------------------------------------------------------#
    #   建议选项：
    #   种类少（几类）时，设置为True
